...
public class Productinfo {
	...
	static Product input() {
		Product p=null;
		System.out.println("1.책|2앨범|3.회화책>>");
		int num=sc.nextInt();
		...
		case 2:
			...
			p=new CompackDisc(id++, comment, productor, price, 
					albumTitle, singer);
			break;
		case 3:
			...
			p=new ConversationBook(id++, comment, productor,
					price, title, author, language);
