...
public class WrapperEx2 {
	...
	public static void main(String[] args) {
		...
		// Character 사용
		System.out.println(Character.toLowerCase('A'));	// 'A'를 소문자로 변
		char c1='4', c2='F';
		...
		System.out.println(Integer.toBinaryString(28)); // 28에 대한 2진수의 1의 개수
		System.out.println(Integer.bitCount(28)); // 28에 대한 2진수의 1의 개수
		Integer i=Integer.valueOf(28);
		System.out.println(i.doubleValue()); // 정수를 double값으로 변환. 28.0
		// Double 사용
